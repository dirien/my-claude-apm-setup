...
dependencies:
  apm:
    ...
    - dirien/my-claude-apm-setup#v0.6.3
includes: auto
```
...
- **Pin it.** An unpinned dep installs the latest commit and drifts; `apm install` warns about it. Pin a tag (`#v0.6.3`) or a commit (`#<sha>`).
